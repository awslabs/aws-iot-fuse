...
public class RepublishActionNode extends TopicRuleActionNode {

    public RepublishActionNode(Node parent, String name, RepublishAction action) {
        super(parent, name);

        addChildren(new InfoNode(this, "role-arn", action.getRoleArn()));
        addChildren(new InfoNode(this, "topic", action.getTopic()));
    }
