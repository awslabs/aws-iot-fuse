...
public class SnsActionNode extends TopicRuleActionNode {

    public SnsActionNode(Node parent, String name, SnsAction action) {
        super(parent, name);

        addChildren(new InfoNode(this, "message-format", action.getMessageFormat()));
        addChildren(new InfoNode(this, "role-arn", action.getRoleArn()));
        addChildren(new InfoNode(this, "target-arn", action.getTargetArn()));
    }
