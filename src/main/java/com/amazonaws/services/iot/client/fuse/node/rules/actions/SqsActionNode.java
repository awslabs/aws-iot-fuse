...
public class SqsActionNode extends TopicRuleActionNode {

    public SqsActionNode(Node parent, String name, SqsAction action) {
        super(parent, name);

        addChildren(new InfoNode(this, "queue-url", action.getQueueUrl()));
        addChildren(new InfoNode(this, "role-arn", action.getRoleArn()));
        addChildren(new InfoNode(this, "use-base64", action.getUseBase64() ? "YES" : "NO"));
    }
