...
public class CloudwatchAlarmActionNode extends TopicRuleActionNode {

    public CloudwatchAlarmActionNode(Node parent, String name, CloudwatchAlarmAction action) {
        super(parent, name);

        addChildren(new InfoNode(this, "alarm-name", action.getAlarmName()));
        addChildren(new InfoNode(this, "role-arn", action.getRoleArn()));
        addChildren(new InfoNode(this, "state-reason", action.getStateReason()));
        addChildren(new InfoNode(this, "state-value", action.getStateValue()));
    }
