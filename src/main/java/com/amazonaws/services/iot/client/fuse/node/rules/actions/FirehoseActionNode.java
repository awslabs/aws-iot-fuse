...
public class FirehoseActionNode extends TopicRuleActionNode {

    public FirehoseActionNode(Node parent, String name, FirehoseAction action) {
        super(parent, name);

        addChildren(new InfoNode(this, "delivery-stream-name", action.getDeliveryStreamName()));
